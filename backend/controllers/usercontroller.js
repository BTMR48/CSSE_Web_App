...
exports.usersignup = async(req,res) => {
    const {name, username, email, nic, phone, credits, password} = req.body;

    try {
        //checking email already exists
        const checkEmail = await User.findOne({email})
        const checkNIC = await User.findOne({nic})
        ...
        //creating a new user
        const user = await User.create({name, username, email, nic, phone, credits, password});
...
exports.userUpdate = async(req,res) => {
    ...
    const {name, username, email, nic, phone, credits} = req.body;

    //object with provided data
    const updateUser = {
        name, username, email, nic, phone, credits
    }
